    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/courses", "/api/courses/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/batches", "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/batches", "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/batches", "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/assignments", "/api/assignments/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.PUT, "/api/assignments", "/api/assignments/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.PATCH, "/api/assignments", "/api/assignments/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.DELETE, "/api/assignments", "/api/assignments/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/modules", "/api/modules/**", "/api/topics", "/api/topics/**", "/api/materials", "/api/materials/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/modules", "/api/modules/**", "/api/topics", "/api/topics/**", "/api/materials", "/api/materials/**").hasAnyRole("ADMIN", "SUPERADMIN")
