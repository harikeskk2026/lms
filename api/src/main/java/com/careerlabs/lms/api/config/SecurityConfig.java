    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.PUT, "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.PATCH, "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
                        .requestMatchers(HttpMethod.DELETE, "/api/batches/**").hasAnyRole("ADMIN", "SUPERADMIN", "TRAINER")
