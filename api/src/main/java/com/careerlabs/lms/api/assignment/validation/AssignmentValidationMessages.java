...
public final class AssignmentValidationMessages {
    ...
    public static final String TOTAL_MARKS_REQUIRED = "Total marks must be between 1 and 100.";
    public static final String TOTAL_MARKS_MIN = "Total marks must be between 1 and 100.";
    public static final String TOTAL_MARKS_MAX = "Total marks must be between 1 and 100.";
