...
public class StudentAttendanceController {
    ...
    @DeleteMapping("/attendance/goal")
    public ResponseEntity<ApiResponse<AttendanceGoalResponse>> clearGoal(
            @AuthenticationPrincipal JwtUserPrincipal principal) {
        AttendanceGoalResponse response = attendanceGoalService.clearGoal(principal.id());
        return ResponseEntity.ok(ApiResponse.of("Goal cleared", response));
    }
