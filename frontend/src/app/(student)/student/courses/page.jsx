    ...
    <div className="page-wrapper">
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            {courses ? (
              <><span className="font-semibold text-brand-600">{courses.length}</span> enrolled course{courses.length !== 1 ? 's' : ''}</>
            ) : 'Loading...'}
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          ...
          <p className="text-gray-500 text-sm">Your enrolled courses will appear here.</p>
        </div>
      ) : (
