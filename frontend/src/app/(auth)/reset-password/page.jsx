  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md animate-fadeInUp">
        <Link href="/forgot-password" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-purple-600 mb-6 transition-colors">
          <ArrowLeft size={16} />
          Back
        </Link>
        ...
        <div className="p-8 bg-white border border-slate-200/90 shadow-xl rounded-3xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            ...
            {!otpParam && (
              <div className="form-group">
                <label className="form-label text-slate-700 font-semibold text-sm">OTP</label>
                <input
                  type="text"
                  inputMode="numeric"
                  maxLength={6}
            ...
            <div className="form-group">
              ...
              <div className="relative">
                <input
                  ...
                  autoFocus
                  className={clsx('w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pr-10 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all', pwdErr && 'border-red-400')}
                />
            ...
            <button type="submit" disabled={loading} className="w-full mt-1 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white font-semibold py-3 rounded-xl shadow-md transition-all">
              {loading ? (
                <>
