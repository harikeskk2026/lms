...
export default function CustomSelect({
  ...
  return (
    <div ref={containerRef} className={`relative min-w-0 ${compact ? 'max-w-56' : 'w-full'}`} onKeyDown={handleKeyDown}>
      ...
      {open && !disabled && (
        <div
          className={`absolute z-50 w-full min-w-[180px] rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden ${align === 'end' ? 'right-0' : ''} ${
