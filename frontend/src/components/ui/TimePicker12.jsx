...
export default function TimePicker12({
  ...
  return (
    <div
      className={`flex items-center gap-1 sm:gap-1.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-2.5 py-2 text-sm text-gray-800 dark:text-gray-200 focus-within:ring-2 focus-within:ring-purple-500 transition-all min-w-0 ${className}`}
    >
