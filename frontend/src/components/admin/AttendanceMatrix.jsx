...
const STATUS_CELL = {
  ...
  HALF_DAY: 'bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-400',
  LEAVE:    'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-400',
  EXCUSED:  'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400',
}

const STATUS_LABEL = { PRESENT: 'P', ABSENT: 'A', LATE: 'L', HALF_DAY: 'H', LEAVE: 'Lv', EXCUSED: 'E' }
          ...
          <tr className="bg-purple-50/70 dark:bg-purple-900/20">
            ...
            {classes.map(cls => (
              <th key={cls.classId} className="px-2 py-3 text-center font-semibold text-purple-600 dark:text-purple-400 whitespace-nowrap min-w-[52px]">
                ...
                <div className="text-[9px] text-gray-400 font-normal truncate max-w-[48px]">{cls.title?.slice(0, 8)}</div>
              </th>
            ))}
