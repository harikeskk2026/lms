          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-purple-100 dark:border-purple-900/30">
                {columns.map(col => (
                  <th key={col.key} className="px-4 py-3 text-left font-semibold text-purple-700 dark:text-purple-300 text-xs uppercase tracking-wider">
                    {col.label}
                  </th>
                ))}
              </tr>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-purple-100 dark:border-purple-900/30 bg-purple-50/50 dark:bg-purple-900/10">
              {columns.map(col => (
                <th key={col.key} className="px-4 py-3 text-left font-semibold text-purple-700 dark:text-purple-300 text-xs uppercase tracking-wider whitespace-nowrap">
                  {col.label}
                </th>
              ))}
            </tr>
